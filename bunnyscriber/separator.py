...
def run_diarization(
    ...
    try:
        ...
        # pyannote 3.x still passes `use_auth_token` into huggingface_hub,
        # which removed that argument in 0.26 — requirements.txt pins
        # huggingface_hub<0.26 to keep the two compatible.
